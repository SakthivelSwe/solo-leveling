...
public class DataSeeder implements CommandLineRunner {
    ...
    public DataSeeder(QuestRepository questRepository, PlayerRepository playerRepository, JdbcTemplate jdbcTemplate) {
    ...
    public void run(String... args) {
        try {
            // Drop old constraint generated by Hibernate when new enums are added
            jdbcTemplate.execute("ALTER TABLE quests DROP CONSTRAINT IF EXISTS quests_category_check");
        } catch (Exception e) {
            // Ignore (e.g. if running on H2 where syntax differs)
        }
        seedQuestsIfEmpty();
        migrateXpReset();
    }
