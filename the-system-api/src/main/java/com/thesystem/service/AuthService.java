...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest req) {
        ...
        // Default skills — start at zero for a true Level 1 Hunter experience.
        PlayerSkill javaSkill = new PlayerSkill(player.getId(), "Java + Spring Boot", 0);
        PlayerSkill dsaSkill = new PlayerSkill(player.getId(), "DSA / LeetCode", 0);
        PlayerSkill angularSkill = new PlayerSkill(player.getId(), "Angular / JavaScript", 0);
        PlayerSkill englishSkill = new PlayerSkill(player.getId(), "English Speaking", 0);
        PlayerSkill sdSkill = new PlayerSkill(player.getId(), "System Design", 0);
